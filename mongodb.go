...
// MongoDB is the interface for a MongoDB database.
...
// Disconnect implements the Disconnect method of the MongoDB interface.
func (db *BasicMongoDB) Disconnect(ctx context.Context) error {
	db.mtx.Lock()
	defer db.mtx.Unlock()
